...
#print('\nRunning ChIPseeker')
annots = ['Rscript', 'workflow/scripts/readsAnno.R', mapping_1M_bed_file_path, assemblies[organism], output_file_ann]
annots = ' '.join(annots)
os.system(annots)

#print('\nRunning ChIPpeakAnno')
annots = ['Rscript', 'workflow/scripts/readsAnnoTSS.R', mapping_1M_bed_file_path, assemblies[organism], output_file_tss]
annots = ' '.join(annots)
os.system(annots)
